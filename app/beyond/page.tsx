  ...
  return (
    <section className="relative overflow-hidden py-20 sm:py-24">
      ...
      <div className="absolute -top-32 -left-32 h-96 w-96 rounded-full
        bg-cyan-200/20 blur-3xl dark:bg-sky-700/20 -z-10" />

      <div className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full
        bg-sky-200/20 blur-3xl dark:bg-teal-700/20 -z-10" />
      ...
      <Container>
        ...
        >
          ...
          <div className="text-center max-w-2xl mx-auto">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-500 dark:text-teal-400">
              Personal
            </p>
          ...
          <Card
            ...
            hover:shadow-xl
            hover:border-cyan-500 dark:hover:border-teal-400
          "
          >
